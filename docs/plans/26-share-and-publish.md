...
- スコープ: `memo`, `tool`, `event`, `calendar`, `todo` の公開設計、公開URL体系、公開ページ責務、公開管理UI
...
### Phase 3: Tool / Event / Calendar Publish

- tool の公開ページをリンク集として整える
...
- publish URL は `/:type/:slug` か `/@/:slug` か
